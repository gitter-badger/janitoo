...
class TestRemoteThread(JNTTThreadRun, JNTTThreadRunCommon):
    ...
    def test_101_values_config(self):
        ...
        print self.thread.bus.nodeman.find_node('remote__node0')
        print self.thread.bus.nodeman.find_node('remote__node1')
        print self.thread.bus.nodeman.find_node('remote__node3')
        print self.thread.bus.nodeman.find_value('remote__node0','users_read').instances
        print self.thread.bus.nodeman.find_value('remote__node1','users_read').instances
        self.assertNotEqual(None, self.thread.bus.nodeman.find_node('remote__node1'))
        self.assertNotEqual(None, self.thread.bus.nodeman.find_node('remote__node0'))
        self.assertNotEqual(None, self.thread.bus.nodeman.find_node('remote__node3'))
        self.assertEqual(2, self.thread.bus.nodeman.find_value('remote__node1','users_read').get_length())
        self.assertEqual(1, self.thread.bus.nodeman.find_value('remote__node0','users_read').get_length())
        self.assertEqual(1, self.thread.bus.nodeman.find_value('remote__node0','users_write').get_length())
        self.assertEqual(3, self.thread.bus.nodeman.find_value('remote__node3','users_read').get_length())
    ...
    def test_102_values_config(self):
        ...
        print self.thread.bus.nodeman.nodes
        print self.thread.bus.nodeman.find_node('remote__node3')
        print self.thread.bus.nodeman.find_value('remote__node3','users_read').instances
        print self.thread.bus.nodeman.find_value('remote__node3','users_write').instances
        self.assertNotEqual(None, self.thread.bus.nodeman.find_node('remote__node3'))
        rvalue = self.thread.bus.nodeman.find_value('remote__node3','users_read')
        ...
        wvalue = self.thread.bus.nodeman.find_value('remote__node3','users_write')
        ...
        print self.thread.bus.nodeman.find_node('remote__node0')
        print self.thread.bus.nodeman.find_value('remote__node0','users_read').instances
        print self.thread.bus.nodeman.find_value('remote__node0','users_write').instances
        self.assertNotEqual(None, self.thread.bus.nodeman.find_node('remote__node0'))
        rvalue = self.thread.bus.nodeman.find_value('remote__node0','users_read')
        print rvalue.get_value_config()
        self.assertEqual(1, rvalue.get_length())
        self.assertEqual(['dht_out_hum','0'], rvalue.get_value_config())
        self.assertEqual(None, rvalue.get_value_config(index=1))
        wvalue = self.thread.bus.nodeman.find_value('remote__node0','users_write')
        print wvalue.get_value_config()
